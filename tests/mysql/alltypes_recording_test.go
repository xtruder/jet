...
SELECT all_types.text = all_types.` + "`" + `char` + "`" + `,
     ...
     REGEXP_LIKE(?, ?),
     REGEXP_LIKE(?, ?, 'i'),
     REGEXP_LIKE(all_types.text, ?, 'i')
FROM test_sample.all_types;
`,
	}, {
		Key:   1,
		Value: []interface{}{"Text", "Text", "Text", "Text", "Text", "Text", "text2", int64(11), "abc", "_b_", "aba", "aba", "ABA", "aba", "aba", "aba", "ABA", "aba", "string1", int64(1), 11.12, "string1", int64(1), 11.12, "Hello %s, %1$s", "World", "abcde", int64(2), "abcde", int64(2), "jose", "Hi", int64(5), "xy", "Hi", int64(5), "xy", int64(33), "BA", "AB", int64(3), int64(3), int64(2), "ABA", "aba", "ABA", "aba", "aba"},
	}})
...
`,
		...
		Value: struct {
			...
			Timestamp:  gotestparrot.Decode("2019-08-06T10:10:30.123456Z", time.Time{}).(time.Time),
			TimestampT: gotestparrot.Decode("2009-11-17T19:34:58.351387Z", time.Time{}).(time.Time),
		},
	}})
