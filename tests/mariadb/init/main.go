...
func init() {
	flag.StringVar(&host, "mariadb-host", "localhost", "mysql host")
	flag.IntVar(&port, "mariadb-port", 3306, "mysql port")
	flag.StringVar(&user, "mariadb-user", "jet", "mysql user")
	flag.StringVar(&password, "mariadb-password", "jet", "mysql password")
